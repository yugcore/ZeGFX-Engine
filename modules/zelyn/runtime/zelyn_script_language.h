...
#ifdef TOOLS_ENABLED
class ZelynEditorLanguage;
#endif

class ZelynScriptLanguage : public ScriptLanguage {
	GDCLASS(ZelynScriptLanguage, ScriptLanguage);

private:
	static ZelynScriptLanguage *singleton;
	BytecodeVM shared_vm;

#ifdef TOOLS_ENABLED
	ZelynEditorLanguage *editor_language = nullptr;
#endif
...
public:
	_FORCE_INLINE_ static ZelynScriptLanguage *get_singleton() { return singleton; }

	virtual String get_name() const override { return "Zelyn"; }
	virtual void init() override;
	virtual String get_type() const override { return "ZelynScript"; }
	virtual String get_extension() const override { return "zl"; }
	...
	virtual bool handles_global_class_type(const String &p_type) const override { return p_type == "ZelynScript"; }
	...
	BytecodeVM &get_shared_vm() { return shared_vm; }
